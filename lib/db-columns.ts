...
export const SAFE_USER_COLUMNS =
  'id,handle,display_name,avatar_url,country,bio,website,location,role,current_city,work_status,timezone,visited_countries,profile_type,hire_cta_label,hire_cta_url,meetup_cta_label,meetup_cta_url,plan,created_at,updated_at' as const
